...
// 导出名字后续更改
// 更改名字为polygonMainTokens
export const polygonMainTokens: NetworkTokens = {
  canonicalWrappedEther: {name: 'Canonical Wrapped Ether', symbol: 'WETH', decimals: 18, address: '0x7ceb23fd6bc0add59e62ac25578270cff1b9f619'},
  // 置空其他tokens
  otherTokens: [
  ],
}; 
